...
//  return hexStringToByteArray(nounceStr);
    ...
    public static void main(String[] args) {
        try {
            ...
            File keyFile = new File("C:\\Users\\trehl\\OneDrive\\Рабочий стол\\DESkey.txt");
            File textFile = new File("C:\\Users\\trehl\\OneDrive\\Рабочий стол\\DESplaintext.txt");
            File cipherFile = new File("C:\\Users\\trehl\\OneDrive\\Рабочий стол\\DESciphertext.txt");
